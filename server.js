//The http object provides features for creating http server in Node.js
// It is used to set up a server that listens on a particular port
// Handle incoming requests
//Send responses to any incoming client request
...
const server = http.createServer((req, res) => {
    ...
    res.end('Hello,I am a full-stack developer!\n');
